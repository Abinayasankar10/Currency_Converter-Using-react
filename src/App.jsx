...
function App() {
  const API_KEY="54ba28dc5ae530ae029a8260";
        ...
        <div className="box">    </div>
          <div className="data">
            ...
            <div className="input">
              ...
              <input type="text"  value={amount} id="amt" onChange={handleAmountChange}/>
            </div>
            <div className="input" >
          ...
          <div className="input" >
            ...
            <select id="toCurrency" value={toCurrency} onChange={handletc}>
            <option value="USD">USD - United States Dollar</option>
              <option value="EUR">EUR - Euro</option>
              <option value="GBP">GBP - British Pound Sterling</option>
              <option value="JPY">JPY - Japanese Yen</option>
